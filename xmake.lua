...
target("REBEL")
	...
	add_links('ncurses', 'tinfo', 'miniupnpc', 'opus', 'pulse', 'pulse-simple')
...
-- add_requires("ncurses", {system = true, configs = {shared = false}})
-- add_requires("miniupnpc", {system = true, configs = {shared = false}})
--
-- target("REBEL")
--     set_kind("binary")
--
